...
export const TRANSLATION_ENTRIES_DE: TranslationEntries = {
  Snapodds_Title_Snap_TV: 'Snap TV',
  Snapodds_Title_Odds: 'Odds',
  Snapodds_Title_Help: 'Hilfe',
  ...
  Snapodds_Odds_BestOdds: 'Besten Odds',
};
